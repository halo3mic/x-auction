...
import {Suave} from "suave-std/suavelib/Suave.sol"; // todo fix remapping
import {EthJsonRPC} from "suave-std/protocols/EthJsonRPC.sol"; // todo fix remapping
...
contract TokenAuction is SuaveContract, Suapp {
    ...
    function cancelAuction(
        ...
        Auction storage auction = auctions[auctionId];
        require(
            auction.auctionMaster == msg.sender,
