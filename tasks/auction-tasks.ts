...
async function submitBid(c: IConfig<ITaskArgsBid>) {
  ...
  await utils
    .prettyPromise(response, c.AuctionContract.interface, "SubmitBid")
    .then(utils.handleResult);
}
...
async function claimToken(c: IConfig<ITaskArgsSimple>) {
  ...
  await utils
    .prettyPromise(response, c.AuctionContract.interface, "ClaimToken")
    .then(utils.handleResult);
}
...
async function initCControl(c: IConfig<ITaskArgsSimple>) {
  ...
  await utils
    .prettyPromise(response, c.AuctionContract.interface, "InitCControl")
    .then(utils.handleResult);
}
